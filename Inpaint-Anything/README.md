> **MODIFIED FOR PILLAR CHATBOT**
> *Note: This submodule has been heavily modified from the original repository. It has been upgraded to use SAM 2.1, wrapped in a Flask API, and optimized for real-time multimodal inference.*
> *Below is the original documentation for reference.*
